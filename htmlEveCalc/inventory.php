...
<body>
  ...
  <div class="container">
	...
	<form class="form" action="inventory.php">
      ...
      <div class="col-md-10">
	<?php if(!empty($_GET)){$_POST['item']=$_GET['item'];}  include 'inventoryLoader.php';?>
      </div>
    </div>
  </div>
