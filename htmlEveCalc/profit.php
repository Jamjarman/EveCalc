...
<body>
  ...
  <div class="navbar navbar-inverse navbar-static-top">
	...
	<div id="navbar" class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
	    ...
	    <li class="active"><a href="profit.php">Profit</a></li>
  ...
  <div class="container">
	...
	<form class="form" action="profit.php">
      ...
      <div class="col-md-10">
	<?php if(!empty($_GET)){$_POST['item']=$_GET['item'];}  include 'profitLoader.php';?>
      </div>
    </div>
  </div>
