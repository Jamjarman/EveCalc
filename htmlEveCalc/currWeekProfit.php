...
echo "<table class=\"table table-striped\"><thead><tr><th>Timeframe</th><th>Profit</th></tr></thead><tbody><tr><td>All Time</td><td>";
echo number_format($profit['totalProfit'], 2)." isk</td></tr><tr><td>This Month</td><td>";
...
echo number_format($monthProfit['totalProfit'], 2)." isk</td></tr><tr><td>This Week</td><td>";
...
echo number_format($weekProfit['totalProfit'], 2)." isk</td></tr><tr><td>Today</td><td>";
...
echo number_format($dayProfit['totalProfit'], 2)." isk</td></tr></tbody></table>";
?>