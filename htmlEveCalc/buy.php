  ...
  <div class="navbar navbar-inverse navbar-static-top">
	...
	<div id="navbar" class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
	    ...
	    <li class="active"><a href="buy.php">Purchases</a></li>
	  </ul>
	</div>
      </div>
   </div>
  ...
  <div class="container">
	...
	<form class="form" action="buy.php">
	  ...
	  <datalist id="datalistNames">
	    <?php $_POST['tableName']="BuyHistory"; include 'loadNamesBuy.php';?>
	  </datalist>
	  </br>
	...
	<form class="form" action="buy.php">
      ...
      <div class="col-md-10">
	<?php if(!empty($_GET)){$_POST['item']=$_GET['item'];}  include 'buyLoader.php';?>
      </div>
    </div>
  </div>
